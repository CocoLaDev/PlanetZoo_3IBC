...
const Login = ({ setIsRegister, setIsLogin, setIsAdmin }: ComponentProps) => {

    const [errorMessage, setErrorMessage] = React.useState<string>("");

    return (
        <div className="relative lg:grid lg:min-h-full lg:grid-cols-12 bg-white">
            <button className="absolute right-3 top-3 w-4 h-4" onClick={() => setIsLogin(false)}>
            ...
            >
                <img
                    alt="Night"
                    src="https://images.gamewatcherstatic.com/image/file/5/7f/99325/vlcsnap-2019-04-17-10h47m59s117.jpg"
            ...
            >
                <div className="max-w-xl lg:max-w-3xl">
                    ...
                    >
                        Connect to Planet Zoo !
                    </h1>

                    <p className="mt-4 leading-relaxed text-gray-500 text-justify">
                        Immerse yourself in the immersive experience of our zoo by logging into your personal account.
                    </p>
