        ...
        <div className="flex flex-1 items-center justify-end md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {isAdmin || data?.role === "admin" &&
              <Link to={"/admin/"} className="hidden rounded-md bg-gray-200 px-5 py-2.5 text-sm font-medium text-teal-800 transition hover:text-teal-800/75 sm:flex items-center gap-1">
