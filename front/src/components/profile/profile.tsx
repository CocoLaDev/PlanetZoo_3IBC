              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  <div className="p-4 bg-teal-100 rounded-xl">
                    <p className="font-bold text-xl text-gray-800 leading-none w-2/3">
                    ...
                    >
                      <input
                        ...
                        id="Password"
                        required
                        className="rounded-xl border p-2 mr-2 text-sm focus:outline-none focus:border-teal-500 transition"
                        placeholder="New password"
                      />
                      <button
                        type="submit"
                        className="inline-flex items-center justify-center py-2 px-3 rounded-xl bg-white text-gray-800 hover:text-teal-500 text-sm font-semibold transition"
                      >
