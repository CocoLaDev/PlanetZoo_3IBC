...
const TiketCard = ({ ticket }: { ticket: Ticket }) => {
    return (
        <a className="group relative block h-64 sm:h-72 w-1/4">
            ...
            >
                ...
                >
                    ...
                    <div className="w-full flex justify-between">
                        <p className="mt-1 font-bold">{ticket.price}€</p>
                        <Link to={`/Tickets/${ticket.index}`} className="text-right font-semibold hover:underline">
                            Show more
                        </Link>
                    </div>
                </div>
